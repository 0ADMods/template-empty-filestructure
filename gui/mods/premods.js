...
function init()
{
	g_EncrytedPassword = Engine.ConfigDB_GetValue("user", "mods.password");
}
...
function modsStart()
{
	...
	var room = Engine.ConfigDB_GetValue("user", "mods.room");
	var history = Number(Engine.ConfigDB_GetValue("user", "mods.history"));

...
ai.Defence.prototype.init = function(gameState)
{
...
ai.Defence.prototype.update = function(gameState, events)
{
...
ai.Defence.prototype.makeIntoArmy = function(gameState, entityID)
{
	...
	var army = new ai.DefenseArmy(gameState, this, [], [entityID]);
	this.armies.push(army);
}

// TODO: this algorithm needs to be improved, sorta.
ai.Defence.prototype.isDangerous = function(gameState, entity)
{
	if (!entity.position())
		return false;
...
ai.Defence.prototype.checkEnemyUnits = function(gameState)
{
	var self = this;
...
ai.Defence.prototype.checkEnemyArmies = function(gameState, events)
{
	var self = this;
...
ai.Defence.prototype.assignDefenders = function(gameState, events)
{
...
ai.Defence.prototype.MessageProcess = function(gameState,events) {
/*	var self = this;
		...
		if (gameState.isEntityOwn(gameState.getEntityById(e.target))) {
			...
			else if (territory == PlayerID || (territory != attacker.owner() && ourUnit.hasClass("Support")))
			{
				...
				if (attacker.hasClass("Structure")) {
					...
					// In which case we must check for other dangerous units around, and perhaps armify theai.
					...
					if (armyID == undefined || !this.enemyArmy[attacker.owner()] || !this.enemyArmy[attacker.owner()][armyID]) {
						if (this.reevaluateEntity(gameState, attacker))
						{
							...
							{
								// armify it, then armify units close to hiai.

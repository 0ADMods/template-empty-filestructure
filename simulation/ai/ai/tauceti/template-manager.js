...
ai.TemplateManager = function(gameState) {
	var self = this;
...
ai.TemplateManager.prototype.AcknowledgeTemplates = function(gameState)
{
	var self = this;
...
ai.TemplateManager.prototype.getBuildableSubtemplates = function(gameState)
{
...
ai.TemplateManager.prototype.getTrainableSubtemplates = function(gameState)
{
	for each (var templateName in this.knownTemplatesList) {
		var template = gameState.getTemplate(templateName);
		if (template !== null) {
...
ai.TemplateManager.prototype.getTemplateCounters = function(gameState)
{
...
ai.TemplateManager.prototype.getCountersToClasses = function(gameState,classes,templateName)
{
